    ...
    public class ConfiggedHeadersMiddleware
    {
        ...
        {   
            ...
            context.Response.OnStarting(state => {
                ...
                httpContext.Response.Headers.Append("AuthoredBy", headerOptions.Value.AuthoredBy);
                httpContext.Response.Headers.Append("LabNumber", headerOptions.Value.LabNumber);
